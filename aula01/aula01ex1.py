...
def aumenta_fib(lista):
    ...
    lista.append (next) #funciona mais rapido pois o APPEND apenas apenda um numero, enquanto o "+" concatena, e sempre cria uma copia,
                        #demorando para efetuar com um numero grande
    return lista
