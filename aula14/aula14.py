...
def RadixSort(A, D): #D é o tamanho da lista
  for d in range(0, D):
...
def carregar_dados_csv(caminho_arquivo):
    ...
    with open(caminho_arquivo, newline='', encoding='utf-8') as csvfile:
        ...
        for linha in leitor:
            ...
            dados.append([nome, roles, pickrate, winrate, banrate, kills, deaths, assists, pentakills, kda])
    return dados
...
if __name__ == "__main__":
    ...
    #objetivo é ordenar em tempo linear
    sort_kda = RadixSort(dados, len(dados))
