...
if __name__ == '__main__':
    ...
    for i in range(len(currentIngredients)):
        ...
        for j in range(1, len(currentIngredients[i])):
            ...
            print (currentItem[i][0])
            print (currentItem[i][j])
        
        #Para a arvore de ingredientes começamos da segunda casa da lista 
        #para não adicionar um item como chave de arvore
        #for j in range(1, len(currentIngredients[i])):
